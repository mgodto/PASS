...
if __name__ == "__main__":
    ...
    # DHS
    # default_input = "data/processed_skeletons/20160927_DHS_lat_V1-0016.npy"
    # default_video = "data/segmentation_dataset_512/alldata/train/20160927_DHS_lat_V1-0016.mp4"

    # LCS
    # default_input = "data/processed_skeletons/20180109_LCS_lat_V1-0035.npy"
    # default_video = "data/segmentation_dataset_512/alldata/train/20180109_LCS_lat_V1-0035.mp4"

    # HipOA
    default_input = "data/processed_skeletons/20170919_HipOA_lat_V1-0009.npy"
    default_video = "data/segmentation_dataset_512/alldata/train/20170919_HipOA_lat_V1-0009.mp4"

    out_path = default_input.replace("data", "results").replace("processed_skeletons", "partition_analysis").replace(".npy", "_partition_analysis.gif")
    # print(out_path)
